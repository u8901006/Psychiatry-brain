#!/usr/bin/env python3
"""
Fetch latest psychiatry & psychology research papers from PubMed E-utilities API.
Targets top psychiatry journals and covers major mental health topics.
"""
...
HEADERS = {"User-Agent": "PsychiatryBrainBot/1.0 (research aggregator)"}
...
def main():
    parser = argparse.ArgumentParser(description="Fetch psychiatry papers from PubMed")
    ...
    out_str = (
        ...
        if args.json
        else json.dumps(output_data, ensure_ascii=False, indent=2)
    )
